// make a fetch call to API that I created
// this call will get all of the predictions
...
function loadTenPredictions(predictions) {
    ...
    predictions.forEach(function(pred) {
        ...
        predDiv.innerHTML += `<p class="pr-3"><strong>${pred.prediction}</strong> with <strong>${pred.certainty}%</strong> certainty (submitted by ${pred.user} at ${pred.date_submitted})</p>
